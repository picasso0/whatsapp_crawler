...
def generate_israeli_mobile_numbers(prefix, length):
...
for mobile_number in generate_israeli_mobile_numbers(prefix, length):
    db.profile.insert_one({"mobile":mobile_number,"whatsapp_searching":0})
